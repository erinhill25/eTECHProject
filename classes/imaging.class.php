...
class Imaging
{
    ...
    public function save_img($path)
    {
        ...
        if($this->resize)
        {
            ...
            imagefill($this->img_output, 0, 0, imagecolorallocatealpha($this->img_output, 0, 0, 0, 127));
            
            imagealphablending( $this->img_output, false );
            imagesavealpha( $this->img_output, true );
            imagecolortransparent($this->img_output, imagecolorallocatealpha($this->img_output, 0, 0, 0, 127));
